...
description: "Slides split on ---, notes after ???, fragments after --, and the file renders as a deck of sections. One plugin for the renderer, present mode and the editor."
---
