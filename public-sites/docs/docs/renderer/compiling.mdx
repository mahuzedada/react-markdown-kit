---
title: "Compiling with compileMarkdown"
sidebar_label: Compiling
description: "Parse Markdown once with compileMarkdown, pass the resulting MarkdownDocument to the renderer, and re-render about 2.8x faster in the benchmark."
---
...
Parsing is about two thirds of the work of rendering Markdown. Doing it once is the whole point.
