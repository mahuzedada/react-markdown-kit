---
title: "Presets: define a Markdown dialect once"
sidebar_label: Presets
description: "Define your Markdown dialect once with defineMarkdownPreset, reuse it across the renderer, editor and templates, and compose presets with extends."
---
