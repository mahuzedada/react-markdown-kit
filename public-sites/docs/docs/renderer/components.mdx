---
title: "Components: override rendered elements"
sidebar_label: Components
description: "Replace any rendered Markdown element with your own React component through the components prop, and read the source node metadata each override receives."
---
...
The renderer overview, with every default in one page: [React Markdown renderer](/react-markdown-renderer).
